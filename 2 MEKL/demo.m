...
inPutInf.kdelta = [0.1, 1, 10]; % parameters of the RBF kernel paramreters
...
for index_cycle = 1:totalCycle;
    ...
    [trnRes, t_train] = MEKL_MSE_MultiClass(trainSet , testSet , inPutInf) ;
...
FinalRes = [FinalRes; [inPutInf.M, res(totalCycle+1, :)]];
